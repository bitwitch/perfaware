...
typedef void ASMFunc(U64 count, U8* data);
...
void nop_3x1_all_bytes(U64 count, U8 *data);
void nop_1x3_all_bytes(U64 count, U8 *data);
void nop_1x9_all_bytes(U64 count, U8 *data);
#pragma comment (lib, "nop_loops")

TestFunc test_functions[] = {
	{"nop_3x1_all_bytes", nop_3x1_all_bytes},
	{"nop_1x3_bytes", nop_1x3_all_bytes},
	{"nop_1x9_bytes", nop_1x9_all_bytes},
};
